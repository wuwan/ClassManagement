...
<form action="courseAdd.action"  method=post id="form1" name="form1">
  <br>
	  ...
	  <!-- --------------------------------------------                 -->
				  <tr>
				    ...
				    <td colspan="5">
				    <input type="text" name="course.courseNumber" value="${course.courseNumber}" class="full"></td>
	    </tr>
	  <!-- --------------------------------------------                 -->
				  <tr>
	  ...
	  <!-- --------------------------------------------                 -->
				  <tr>
				    ...
				    <td colspan="5">
				    <select name="course.property" id="course.property">  
				    <option>必修</option>
				    <option>选修</option>
				    <option>学位</option>
				    </select>
