...
<form action="studentUpdate.action"  method=post id="form1" name="form1">
  <br>
	  ...
	  <!-- --------------------------------------------                 -->
				  <tr>
				    <td><span>*</span>学号</td>	    
				    <td colspan="5">
				    <input type="text" name="user.sno" value="${user.sno}" class="full" readonly="readonly"></td>
	    </tr>
	  <!-- --------------------------------------------                 -->
				  <tr>
				    <td><span>*</span>姓名</td>	    
	  ...
	  <!-- --------------------------------------------                 -->
				  <tr>
				    <td><span>*</span>所属班级</td>	    
				    <td colspan="5">${user.claM.cno}
